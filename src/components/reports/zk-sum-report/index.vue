      ...
      async init () {
        ...
        if (this.widget && this.widget.value) {
          ...
          if (this.widget.value.dataReport) {
            ...
            para.condition.startTime = timer.timeFormat(date)
