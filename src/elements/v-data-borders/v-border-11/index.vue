<template>
  <div class="v-border-box-11" :ref="ref">
    <svg class="dv-border-svg-container" :width="width" :height="height">
      ...
      <polygon :stroke="mergedColor[0]" :fill="fade(mergedColor[1] || defaultColor[1], 30)" :filter="`url(#${filterId})`" :points="`
      ...
      <text :x="`${width / 2}`" y="32" fill="#fff" font-size="18" text-anchor="middle" dominant-baseline="middle">
        {{ title }}
      </text>
