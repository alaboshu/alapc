...
// 租户相关接口
export const TENANT_LOGIN_GET = '/Api/Tenant/login'
...
export const USERADDRESS_GETADDADDRESSFORM_GET =
  '/api/useraddress/getaddaddressform' // 获取添加地址视图
export const USERADDRESS_SAVEORDERADDRESS_POST =
  '/api/useraddress/saveorderaddress' // 更新、添加、保存收货地址
export const USERADDRESS_SAVEUSERINFOADDRESS_POST =
  '/api/useraddress/saveuserinfoaddress' // 备案地址修改
...
export const USERADDRESS_QUERYFIELDVALUE_GET =
  '/api/useraddress/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const USER_REG_POST = '/Api/Member/Reg' // 会员注册
...
export const SHAREORDERREPORT_QUERYUSERLIST_GET =
  '/api/shareorderreport/queryuserlist' // 查询登录用户分页数据
export const SHAREORDERREPORT_QUERYFIELDVALUE_GET =
  '/api/shareorderreport/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const SHAREORDERREPORT_QUERYUPDATE_PUT =
  '/api/shareorderreport/queryupdate' // 修改单条记录
export const SHAREORDERREPORT_QUERYPAGELIST_GET =
  '/api/shareorderreport/querypagelist' // 动态Url分页查询
export const SHAREORDERREPORT_QUERYLIST_GET = '/api/shareorderreport/querylist' // 根据Url获取列表
export const SHAREORDERREPORT_QUERYDELETE_DELETE =
  '/api/shareorderreport/querydelete' // 删除单条记录
export const SHAREORDERREPORT_BATCHDELETE_POST =
  '/api/shareorderreport/batchdelete' // 删除单条记录
...
export const UPGRADERECORD_QUERYUSERLIST_GET =
  '/api/upgraderecord/queryuserlist' // 查询登录用户分页数据
export const UPGRADERECORD_QUERYFIELDVALUE_GET =
  '/api/upgraderecord/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const UPGRADERECORD_QUERYPAGELIST_GET =
  '/api/upgraderecord/querypagelist' // 动态Url分页查询
...
export const MESSAGEQUEUE_QUERYFIELDVALUE_GET =
  '/api/messagequeue/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const RELATION_GETFATHERKEYVALUES_GET =
  '/api/relation/getfatherkeyvalues' // 父级分类
...
export const RELATIONINDEX_QUERYUSERLIST_GET =
  '/api/relationindex/queryuserlist' // 查询登录用户分页数据
export const RELATIONINDEX_QUERYFIELDVALUE_GET =
  '/api/relationindex/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const RELATIONINDEX_QUERYPAGELIST_GET =
  '/api/relationindex/querypagelist' // 动态Url分页查询
...
export const STORAGEFILE_QUERYFIELDVALUE_GET =
  '/api/storagefile/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const WIDGETHISTORY_QUERYUSERLIST_GET =
  '/api/widgethistory/queryuserlist' // 查询登录用户分页数据
export const WIDGETHISTORY_QUERYFIELDVALUE_GET =
  '/api/widgethistory/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const WIDGETHISTORY_QUERYPAGELIST_GET =
  '/api/widgethistory/querypagelist' // 动态Url分页查询
...
export const WIDGETSYSTEMDATA_QUERYUSERLIST_GET =
  '/api/widgetsystemdata/queryuserlist' // 查询登录用户分页数据
export const WIDGETSYSTEMDATA_QUERYFIELDVALUE_GET =
  '/api/widgetsystemdata/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const WIDGETSYSTEMDATA_QUERYUPDATE_PUT =
  '/api/widgetsystemdata/queryupdate' // 修改单条记录
export const WIDGETSYSTEMDATA_QUERYPAGELIST_GET =
  '/api/widgetsystemdata/querypagelist' // 动态Url分页查询
export const WIDGETSYSTEMDATA_QUERYLIST_GET = '/api/widgetsystemdata/querylist' // 根据Url获取列表
export const WIDGETSYSTEMDATA_QUERYDELETE_DELETE =
  '/api/widgetsystemdata/querydelete' // 删除单条记录
export const WIDGETSYSTEMDATA_BATCHDELETE_POST =
  '/api/widgetsystemdata/batchdelete' // 删除单条记录
...
//  SiteTheme相关的API接口
export const SITETHEME_SECURITYVERIFICATION_POST =
  '/api/sitetheme/securityverification' // 安全验证
...
export const PRODUCTBUYSTOCK_QUERYUSERLIST_GET =
  '/api/productbuystock/queryuserlist' // 查询登录用户分页数据
export const PRODUCTBUYSTOCK_QUERYFIELDVALUE_GET =
  '/api/productbuystock/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const PRODUCTBUYSTOCK_QUERYUPDATE_PUT =
  '/api/productbuystock/queryupdate' // 修改单条记录
export const PRODUCTBUYSTOCK_QUERYPAGELIST_GET =
  '/api/productbuystock/querypagelist' // 动态Url分页查询
export const PRODUCTBUYSTOCK_QUERYLIST_GET = '/api/productbuystock/querylist' // 根据Url获取列表
export const PRODUCTBUYSTOCK_QUERYDELETE_DELETE =
  '/api/productbuystock/querydelete' // 删除单条记录
export const PRODUCTBUYSTOCK_BATCHDELETE_POST =
  '/api/productbuystock/batchdelete' // 删除单条记录
...
export const USERSTOCK_OFFLINEDELIVERYPRODUCT_GET =
  '/api/userstock/offlinedeliveryproduct' // 根据订单，查询订单发货商品以及发货商品数量
...
export const PRESELLORDER_QUERYFIELDVALUE_GET =
  '/api/presellorder/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const PRESELLPRODUCT_QUERYUSERLIST_GET =
  '/api/presellproduct/queryuserlist' // 查询登录用户分页数据
export const PRESELLPRODUCT_QUERYFIELDVALUE_GET =
  '/api/presellproduct/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const PRESELLPRODUCT_QUERYPAGELIST_GET =
  '/api/presellproduct/querypagelist' // 动态Url分页查询
export const PRESELLPRODUCT_QUERYLIST_GET = '/api/presellproduct/querylist' // 根据Url获取列表
export const PRESELLPRODUCT_QUERYDELETE_DELETE =
  '/api/presellproduct/querydelete' // 删除单条记录
...
export const PRODUCTDETAIL_QUERYUSERLIST_GET =
  '/api/productdetail/queryuserlist' // 查询登录用户分页数据
export const PRODUCTDETAIL_QUERYFIELDVALUE_GET =
  '/api/productdetail/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const PRODUCTDETAIL_QUERYPAGELIST_GET =
  '/api/productdetail/querypagelist' // 动态Url分页查询
...
export const PRODUCTLINE_QUERYFIELDVALUE_GET =
  '/api/productline/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const ORDERACTION_QUERYFIELDVALUE_GET =
  '/api/orderaction/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const ORDERDELIVERY_QUERYUSERLIST_GET =
  '/api/orderdelivery/queryuserlist' // 查询登录用户分页数据
export const ORDERDELIVERY_QUERYFIELDVALUE_GET =
  '/api/orderdelivery/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const ORDERDELIVERY_QUERYPAGELIST_GET =
  '/api/orderdelivery/querypagelist' // 动态Url分页查询
...
export const ORDERPRODUCT_QUERYFIELDVALUE_GET =
  '/api/orderproduct/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const CATEGORYPROPERTY_QUERYUSERLIST_GET =
  '/api/categoryproperty/queryuserlist' // 查询登录用户分页数据
export const CATEGORYPROPERTY_QUERYFIELDVALUE_GET =
  '/api/categoryproperty/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const CATEGORYPROPERTY_QUERYUPDATE_PUT =
  '/api/categoryproperty/queryupdate' // 修改单条记录
export const CATEGORYPROPERTY_QUERYPAGELIST_GET =
  '/api/categoryproperty/querypagelist' // 动态Url分页查询
export const CATEGORYPROPERTY_QUERYLIST_GET = '/api/categoryproperty/querylist' // 根据Url获取列表
export const CATEGORYPROPERTY_QUERYDELETE_DELETE =
  '/api/categoryproperty/querydelete' // 删除单条记录
export const CATEGORYPROPERTY_BATCHDELETE_POST =
  '/api/categoryproperty/batchdelete' // 删除单条记录
...
export const CATEGORYPROPERTYVALUE_QUERYUSERLIST_GET =
  '/api/categorypropertyvalue/queryuserlist' // 查询登录用户分页数据
export const CATEGORYPROPERTYVALUE_QUERYFIELDVALUE_GET =
  '/api/categorypropertyvalue/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
export const CATEGORYPROPERTYVALUE_NEXTBYID_GET =
  '/api/categorypropertyvalue/nextbyid' // 根据Id获取下一条记录
export const CATEGORYPROPERTYVALUE_PREXBYID_GET =
  '/api/categorypropertyvalue/prexbyid' // 根据Id获取上一条记录
export const CATEGORYPROPERTYVALUE_QUERYADD_POST =
  '/api/categorypropertyvalue/queryadd' // 增加单条记录
export const CATEGORYPROPERTYVALUE_QUERYUPDATE_PUT =
  '/api/categorypropertyvalue/queryupdate' // 修改单条记录
export const CATEGORYPROPERTYVALUE_QUERYPAGELIST_GET =
  '/api/categorypropertyvalue/querypagelist' // 动态Url分页查询
export const CATEGORYPROPERTYVALUE_QUERYLIST_GET =
  '/api/categorypropertyvalue/querylist' // 根据Url获取列表
export const CATEGORYPROPERTYVALUE_QUERYDELETE_DELETE =
  '/api/categorypropertyvalue/querydelete' // 删除单条记录
export const CATEGORYPROPERTYVALUE_BATCHDELETE_POST =
  '/api/categorypropertyvalue/batchdelete' // 删除单条记录
export const CATEGORYPROPERTYVALUE_QUERYBYID_GET =
  '/api/categorypropertyvalue/querybyid' // 根据Id获取单个实例
export const CATEGORYPROPERTYVALUE_QUERYDIC_GET =
  '/api/categorypropertyvalue/querydic' // 根据Id获取单个实例字典集合
...
export const ACTIVITYRECORD_QUERYUSERLIST_GET =
  '/api/activityrecord/queryuserlist' // 查询登录用户分页数据
export const ACTIVITYRECORD_QUERYFIELDVALUE_GET =
  '/api/activityrecord/queryfieldvalue' //  根据Id和字段名称,获取单个字段的值
...
export const ACTIVITYRECORD_QUERYPAGELIST_GET =
  '/api/activityrecord/querypagelist' // 动态Url分页查询
export const ACTIVITYRECORD_QUERYLIST_GET = '/api/activityrecord/querylist' // 根据Url获取列表
export const ACTIVITYRECORD_QUERYDELETE_DELETE =
  '/api/activityrecord/querydelete' // 删除单条记录
