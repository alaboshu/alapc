  ...
  <div class="user-level">
    <div class="alert-success">
      <div class="alert-success_box">
        <p>根据匠芯云多年的分润经验以及大量的客户见证，建议整个系统的分润体系设置多个用户类型，每个用户类型设置3个左右的等级，这样更容易让企业的商业模式闭环。</p>
        <p>限制的为触发用户类型</p>
      </div>
    </div>
    ...
    <x-line :border="true" title="订单用户,触发会员设置" color="metal" icon="null" style="padding:0px 15px;">
      ...
      <edit-range-user-form v-show="viewModel.userConfig.shareUser.isLimitShareUserType" type="ShareUserGrade" :viewModel="viewModel.userConfig.shareUser"></edit-range-user-form>
    </x-line>
  </div>
</template>
<script>
