  ...
  export default {
    ...
    methods: {
      async  init () {
        ...
        if (this.widgetData.value !== undefined && this.widgetData.value !== null && this.widgetData.value !== undefined) {
          if (this.widgetData.value.title !== null && this.widgetData.value.title !== undefined) {
