<template>
  <div class="template_reg">
    <el-row :gutter="10" style="background-color:aliceblue">
      ...
      <el-col :span="2">
        <el-button type="text" @click="modification">修改</el-button>
      ...
      <el-col :span="2">
        <el-button @click="deleteFee" type="text">删除</el-button>
      </el-col>
      <el-col :span="2">
        <el-input v-model="regionfee.startStandard"></el-input>
      </el-col>
      <el-col :span="2">
        <el-input v-model="regionfee.startFee"></el-input>
      </el-col>
      <el-col :span="2">
        <el-input v-model="regionfee.endStandard"></el-input>
      </el-col>
      <el-col :span="2">
        <el-input v-model="regionfee.endFee"></el-input>
      </el-col>
    </el-row>
  </div>
</template>
